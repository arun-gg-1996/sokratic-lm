...
"""
    ...
    try:
        ...
        from scispacy.linking import EntityLinker  # type: ignore # noqa: — registers the pipeline component
...
"""
    ...
    # "openstax_anatomy" added — it's the v1-rebuild retrieval_domain
