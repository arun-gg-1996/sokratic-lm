...
class StartSessionRequest(BaseModel):
    ...
    # : client-local hour (0-23) so the rapport greeting picks
    ...
    # VLM JSON from a prior /api/vlm/upload call. When present
...
class StartSessionResponse(BaseModel):
    ...
    # initial pending_user_choice (anchor_pick cards). Set when
